...
from services.card_service import upload_file_for_card, get_card_files, remove_file
...
import os
from services.converter_service import convert_model_to_dto, __get_json_parameter
...
def deleteFile(jwt_data: dict) -> None:
    ...
    if file_id in processing_files:
        return {
            "error_message": "Вы не можете удалить этот файл, так как он в процессе обработки. \
