...
from services.model_settings_service import (update_default_model_settings_handler,
...
model_settings_controller_blueprint = Blueprint('model_settings_controller_blueprint', __name__)

@model_settings_controller_blueprint.route('/api/v1/overrideModelSettingsForFile', methods=['POST'])
@token_required
...
@model_settings_controller_blueprint.route('/api/v1/overrideDefaultModelSettingsForFile', methods=['POST'])
@token_required
@endpoint_output_wrapper
...
@model_settings_controller_blueprint.route('/api/v1/getModelSettingsForFile/<path:id>', methods=['GET'])
@token_required
@endpoint_output_wrapper
...
@model_settings_controller_blueprint.route('/api/v1/getDefaultModelSettingsForFile', methods=['GET'])
@token_required
@endpoint_output_wrapper
