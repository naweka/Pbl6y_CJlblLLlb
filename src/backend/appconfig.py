...
PATH_TO_THE_MODEL = WORKING_DIRECTORY + "/packed_model/unpacked/swin_audio.pth"
PATH_TO_THE_MODEL_FOLDER = WORKING_DIRECTORY + "/packed_model/unpacked"
PATH_TO_THE_PACKED_MODEL_FOLDER = WORKING_DIRECTORY + "/packed_model/"
