		...
		>
			{value.map((item, index) => (
				...
				>
					...
					>
						<span className="sr-only">Удалить опцию {item}</span>
...
>(({ className, ...props }, _) => {
	...
	return (
		<CommandPrimitive.Input
			...
			className={cn(
				'ml-2 flex-1 overflow-hidden bg-transparent outline-none placeholder:text-muted-foreground',
				className,
