...
export const FIELDS_CARD: Record<FieldKey, FormSwitcherProps> = {
	window_size: {
		...
		hintMsg: 'Длина интервала аудио (в секундах), который будет за раз обрабатываться моделью. Рекомендовано от 0.5 до 1 секунды.',
	},
	window_step: {
		name: 'window_step',
		component: FieldTypes.Slider,
		label: 'Интервал движения окна',
		hintMsg: 'На сколько секунд будет сдвинуто окно обработки. Рекомендовано треть или четверть от длины окна.',
	},
	min_sound_length: {
		name: 'min_sound_length',
		component: FieldTypes.Slider,
		label: 'Минимальная длина звука',
		hintMsg: 'Если интервал предсказания получился меньше этого значения — не добавлять его в результат.',
	},
	ignore_noise_outliers: {
		name: 'ignore_noise_outliers',
		component: FieldTypes.Select,
		label: 'Политика работы с вбросами шума',
		hintMsg: 'В зависимости от значения, делить или не делить один интервал на два, если посреди большого интервала возникает короткий кусочек шума.',
	},
	ignore_sound_outliers: {
		name: 'ignore_sound_outliers',
		component: FieldTypes.Select,
		label: 'Политика работы с вбросами звука',
		hintMsg: 'В зависимости от значения, вставлять или не вставлять предсказание короткого кусочка звука, который возник в шуме.',
	},
	confidence_limit: {
		name: 'confidence_limit',
		component: FieldTypes.Slider,
		label: 'Порог средней уверенности модели на интервале со звуком',
		hintMsg: 'Нижняя граница средней уверенности в предсказанном интервале, начиная с которой, интервал будет добавлен.',
	},
	offset_bounds: {
		name: 'offset_bounds',
		component: FieldTypes.Slider,
		label: 'Обрезка интервалов с краёв',
		hintMsg: 'Возможность обрезать интервалы с краёв на некоторый % от длины окна.',
	},
}
