...
import { AuthTogglers, FIELDS_SIGN_IN, formSchemaValidateSignIn as formSchema } from '../../authConstants'
        ...
        <Card className="max-w-sm w-full">
            ...
            <CardContent>
                ...
                <div className="mt-4 text-center text-sm">
                    ...
                    <Button variant="link" onClick={() => setActive(AuthTogglers.SIGN_UP)} className="p-0 h-4">
                        Зарегистрироваться
                    </Button>
                </div>
            </CardContent>
